...
\begin{lstlisting}[style=bashstyle, caption={Generate an ed25519 SSH key pair}]
ssh-keygen -t ed25519 -C "your_email@example.com"
\end{lstlisting}
...
\begin{lstlisting}[style=windowsStyle, caption={Default key location on Windows}]
...
\begin{lstlisting}[style=bashstyle, caption={Start the SSH agent and add the private key}]
eval "$(ssh-agent -s)"
ssh-add ~/.ssh/id_ed25519
\end{lstlisting}
...
\begin{lstlisting}[style=bashstyle, caption={Display the public key}]
cat ~/.ssh/id_ed25519.pub
\end{lstlisting}
...
\begin{lstlisting}[style=bashstyle, caption={Test the SSH connection to GitHub}]
ssh -T git@github.com
\end{lstlisting}
...
\begin{lstlisting}[style=inlineStyle, caption={Expected response from GitHub}]
...
\begin{lstlisting}[style=bashstyle, caption={Clone a repository over SSH}]
git clone git@github.com:USER/REPOSITORY.git
\end{lstlisting}
