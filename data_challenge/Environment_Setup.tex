...
for the DAIR\textsuperscript{3} program. Work through the Required
...
Now that Git is installed, clone the DAIR\textsuperscript{3} workshop
...
This creates a folder called \texttt{DAIR3-Workshop} containing all
...
%================================================================
\section{Required: Open the DAIR3 project in Visual Studio Code}\label{sec:vscstart}
%================================================================

To open the DAIR3 project in VSC, open a terminal, navigate into the
\texttt{DAIR3-Workshop} folder you cloned in the previous section,
and run:
...
Install the core scientific Python libraries into your DAIR3 virtual
environment. If you have not yet set up a virtual environment, complete
Chapter~\ref{ch:python-environments} first, then return here.

\vs
\noindent
With the DAIR3 environment active, install the required libraries:

\begin{verbatim}
pip install numpy pandas matplotlib scipy jupyter
\end{verbatim}

These five libraries are sufficient for the data challenge analysis.
Additional libraries required for the LLM chapter (including
\texttt{openai}, \texttt{anthropic}, and \texttt{langchain}) are
installed separately in Chapter~\ref{ch:ollama-infrastructure}.

\vs
\noindent
To verify the installation, start the Python interpreter and import
each library:

\begin{verbatim}
python
>>> import numpy, pandas, matplotlib, scipy, jupyter
...
\texttt{resources/unit\_7/FOO/} in the DAIR3-Workshop repository.
...
If you encounter a different issue, consult the DAIR3 repository
issue tracker at \url{https://github.com/DAIR3/DAIR3-Workshop/issues}.
...
%================================================================
\section{Optional: Installing LaTeX Tools on Linux}
%================================================================
Most Linux distributions provide the \texttt{TeX Live} distribution,
which includes the LaTeX compiler and a large collection of packages
for document preparation.

The following procedure installs the basic tools required to compile
LaTeX documents on Ubuntu or Debian-based systems.
...
%----------------------------------------------------------------
\subsection{Install Core LaTeX Packages}
%----------------------------------------------------------------
Install the essential components of the TeX Live distribution:
...
These packages provide the LaTeX compiler, common fonts,
and widely used packages required by most academic documents.

%----------------------------------------------------------------
\subsection{Install the \texttt{latexmk} Build Tool}
%----------------------------------------------------------------
The \texttt{latexmk} utility automates the compilation process by
running the required sequence of LaTeX and bibliography commands.
...
%----------------------------------------------------------------
\subsection{Compile a LaTeX Document}
%----------------------------------------------------------------
Assuming a file named \texttt{document.tex} exists in the current
...
This command automatically runs \texttt{pdflatex}, \texttt{bibtex} or
\texttt{biber}, and any additional compilation passes required to
resolve references.
...
The output should display the installed \texttt{pdfTeX} or
\texttt{TeX Live} version.

%----------------------------------------------------------------
\subsection{Optional: Install the Complete TeX Live Distribution}
%----------------------------------------------------------------
For systems with sufficient disk space, the entire TeX Live
...
This installation includes all available LaTeX packages and tools.
